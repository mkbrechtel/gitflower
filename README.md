...
gitflower is openly developed with substantial LLM assistance under human
maintenance. We respect the outcome of the vote, even though we see the
role of these tools in free software differently — so rather than argue
about the boundaries of the policy, we comply with it and move development
elsewhere. We leave with genuine regret, and we wish the Codeberg
